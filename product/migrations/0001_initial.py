# Generated by Django 4.0.3 on 2022-03-10 08:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='product', to='product.category')),
            ],
            options={
                'ordering': ['-pk', 'name'],
            },
