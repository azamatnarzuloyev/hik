    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='product_category', to='product.category')),
                ('status', models.ManyToManyField(to='product.status')),
            ],
            options={
                'ordering': ['-pk', 'name'],
            },
